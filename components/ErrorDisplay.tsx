...
const ErrorDisplay: React.FC = () => {
  ...
  return (
    <div className="alert-base alert-danger w-full max-w-3xl mx-auto" role="alert">
      <AlertIcon className="h-6 w-6 mr-3 text-[var(--color-danger-text)] flex-shrink-0 mt-1" />
      ...
      <button onClick={() => setError(null)} className="p-1 ml-4 -mt-1 -mr-1 rounded-full hover:bg-[var(--color-interactive-bg-hover)] transition-colors" aria-label="Dismiss">
