  ...
  if (contrastClarificationNeeded) {
    return (
      <div className="w-full max-w-3xl p-4 animate-fade-in text-center glass-panel">
        <h3 className="text-lg font-semibold text-(--color-text-bright) mb-2">Clarification Needed</h3>
        <p className="text-(--color-text-muted) mb-4">
          The study type <strong className="text-(--color-text-default)">"{contrastClarificationNeeded.studyType}"</strong> is ambiguous. Please specify the use of contrast.
        </p>
  ...
  return (
    <div className="w-full max-w-3xl p-4 animate-fade-in space-y-4">
      <div className="glass-panel p-4">
        <label htmlFor="examDate" className="block text-xs font-bold uppercase text-(--color-secondary) tracking-wider mb-2">
          Date & Time of Study
        </label>
        <input
          id="examDate"
