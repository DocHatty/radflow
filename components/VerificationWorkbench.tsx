  ...
  return (
    <Panel className="animate-fade-in">
      <div className="flex flex-col items-center justify-center text-center py-4">
        <h3 className="text-lg font-bold text-(--color-text-bright)">Ready to Proceed?</h3>
        <p className="text-sm text-(--color-text-muted) max-w-sm mx-auto my-2">
          The clinical brief has been generated. Please review and edit the details on the left.
          When ready, confirm to generate the AI-powered report draft.
        </p>
        <ActionButton
          onClick={onConfirm}
          ...
          title={
            isExamDateMissing
              ? "Please provide the exam date in the brief"
