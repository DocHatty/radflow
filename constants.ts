    ...
    priors: {
      ...
      items: {
        ...
        properties: {
          ...
          date: {
            type: Type.STRING,
            description: "The date of the prior report, if available. Format as YYYY-MM-DD.",
          },
        },
      },
      ...
      items: {
        ...
        properties: {
          ...
          rationale: {
            type: Type.STRING,
            description:
              "A brief rationale explaining why this is a consideration based on the findings.",
          },
          likelihood: {
            type: Type.STRING,
...
export const FINAL_REVIEW_SCHEMA = {
  ...
  properties: {
    recommendations: {
      type: Type.ARRAY,
      description:
        "A list of specific, actionable recommendations for improvement. If the report is perfect, this array will be empty.",
      items: {
        type: Type.STRING,
      },
    },
...
export const GUIDELINE_SELECTION_SCHEMA = {
  ...
  properties: {
    relevantGuidelineTopics: {
      type: Type.ARRAY,
      description:
        'An array of strings, where each string is the exact "topic" of a relevant guideline from the provided list.',
      items: {
        type: Type.STRING,
      },
    },
